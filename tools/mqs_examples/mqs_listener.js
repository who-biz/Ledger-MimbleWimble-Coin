...
const REQUEST_GET_MQS_TIMESTAMP_SIGNATURE_INSTRUCTION = 0x15;
...
(async function() {
	...
	// Display message
	console.log("Getting timestamp signature from hardware wallet");
	
	// Get the timestamp signature from the hardware wallet
	response = await hardwareWallet.send(REQUEST_CLASS, REQUEST_GET_MQS_TIMESTAMP_SIGNATURE_INSTRUCTION, NO_PARAMETER, NO_PARAMETER, Buffer.concat([
